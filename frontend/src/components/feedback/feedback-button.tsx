  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-6 left-6 z-20 h-10 w-10 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center sm:h-9 sm:w-auto sm:px-3 sm:rounded-md sm:gap-1.5"
        title="Send Feedback"
      >
