...
- [~] Phase 5 (AI Platform): Steps 1-3 DONE — estimate_generator pilot, email_drafter migration (flag-gated via `EMAIL_DRAFTER_USE_PROPOSALS`, live on Sapphire 2026-04-23), customer_matcher low-confidence review queue at `/inbox/matches`. Steps 4 (historical `draft_response` port) + 5 (audit enforcer + closeout) REMAINING. Spec: `docs/ai-platform-phase-5.md`.
