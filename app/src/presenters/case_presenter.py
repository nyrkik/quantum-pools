...
class CasePresenter(Presenter):
    ...
    def _serialize(self, case: ServiceCase, customer_name: str | None = None) -> dict:
        return {
            ...
            "billing_name": case.billing_name,
            "status": case.status,
            ...
            "current_actor_name": case.current_actor_name,
            ...
            "flags": {
                "estimate_approved": case.flag_estimate_approved,
                "estimate_rejected": case.flag_estimate_rejected,
                "payment_received": case.flag_payment_received,
                "customer_replied": case.flag_customer_replied,
                "jobs_complete": case.flag_jobs_complete,
                "invoice_overdue": case.flag_invoice_overdue,
                "stale": case.flag_stale,
            },
