  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-20 left-4 z-[70] h-10 w-10 rounded-full bg-primary text-primary-foreground shadow-lg hover:shadow-xl transition-shadow flex items-center justify-center sm:bottom-6 sm:left-[17.5rem] sm:h-9 sm:w-auto sm:px-3 sm:rounded-md sm:gap-1.5"
        title="Send Feedback"
      >
